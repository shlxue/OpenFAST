...
public class OperatorTest extends TestCase {
	...
	{
		Scalar field = new Scalar("operatorName", Type.UNSIGNED_INTEGER, Operator.DEFAULT, new IntegerValue(1), false);
...
//		newly added implementation
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.COPY, ScalarValue.UNDEFINED, true);
		Operator copy = Operator.getOperator(Operator.COPY, Type.UNSIGNED_INTEGER);
	...
	public void testCopyOperatorWithOptionalPresence()
	{
		...
		//newly added implementation	
		Scalar field1 = new Scalar("", Type.UNSIGNED_INTEGER, Operator.COPY, ScalarValue.UNDEFINED, true);
		assertEquals(null, copy.decodeEmptyValue(ScalarValue.UNDEFINED, field1));
	}
	
	public void testIncrementOperatorWithNoDefaultValue()
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.INCREMENT, false);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.INCREMENT, new IntegerValue(1), false);
	...
	public void testDeltaValueOperatorForEncodingIntegerValue()
	{
		...
		field = new Scalar("", Type.SIGNED_INTEGER, Operator.DELTA, new IntegerValue(25), false);
	...
	public void testDeltaValueOperatorForDecodingIntegerValue()
	{
		...
		Scalar field = new Scalar("", Type.SIGNED_INTEGER, Operator.DELTA, new IntegerValue(25), false);
		assertEquals(new IntegerValue(30), Operator.DELTA_INTEGER.decodeValue(new IntegerValue(5), ScalarValue.UNDEFINED, field));
//		newly added implementation
		Scalar field2 = new Scalar("", Type.SIGNED_INTEGER, Operator.DELTA, new IntegerValue(25), false);
		...
		Scalar field1 = new Scalar("", Type.SIGNED_INTEGER, Operator.DELTA, ScalarValue.UNDEFINED, true);
	...
	{
		try {
			Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.DELTA, new IntegerValue(25), false);
			Operator.DELTA_INTEGER.decodeValue(new IntegerValue(30), null, field);
			//newly added implementation
			Scalar field1 = new Scalar("", Type.UNSIGNED_INTEGER, Operator.DELTA, ScalarValue.UNDEFINED, false);
			assertEquals(ScalarValue.UNDEFINED,Operator.DELTA_INTEGER.decodeEmptyValue(ScalarValue.UNDEFINED, field1));
			fail();
		} catch (IllegalStateException e) {
			assertEquals(Operator.ERR_D9, e.getMessage());
	...
	public void testDeltaOperatorForOptionalUnsignedInteger() {
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.DELTA, true);
