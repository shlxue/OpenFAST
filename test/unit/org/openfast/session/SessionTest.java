...
public class SessionTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		server = new FastServer("server", new RecordingSessionFactory(factory.createLocalSessionFactory()));
	...
	public void testBasicSessionInitialization() throws FastConnectionException, InterruptedException {
		...
		assertEquals(expectedServerInput, serverSession.in.getUnderlyingStream().toString());
		assertEquals(expectedServerOutput, serverSession.out.getUnderlyingStream().toString());
	}
	
	public void testUnregisteredTemplateError() throws FastConnectionException, InterruptedException {
		...
		//                             --PMAP-- ----TID=16001---- ---1=2-- --2=11-- -3=NULL- -4=<ERR MESSAGE>
									  "11000000 01111101 10000001 10000010 10001011 10000000 " + ByteUtil.convertByteArrayToBitString(Type.STRING_TYPE.encode(new StringValue("Template not supported")));
	...
	public void testAuthenticationError() throws InterruptedException, FastConnectionException {
		server.setConnectionListener(new ConnectionListener() {
			public boolean isValid(Client client) {
				return false;
			}
	...
	public void testFastReset() throws FastConnectionException {
		...
		serverSession.in.registerTemplate(ObjectMother.QUOTE_TEMPLATE_ID, quoteTemplate);
		session.out.registerTemplate(ObjectMother.QUOTE_TEMPLATE_ID, quoteTemplate);
