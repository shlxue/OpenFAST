...
public class ExhaustiveOperatorTest extends TestCase {
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.NONE, ScalarValue.UNDEFINED, true);
	...
	public void testEmptyOperatorWithOptionalFieldOnNullValue() throws Exception
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.NONE, ScalarValue.UNDEFINED, true);
		MessageTemplate template = registerTemplate(field);
	...
	public void testEmptyOperatorWithSequenceOfMessages() throws IOException
	{
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.NONE, false);
		MessageTemplate template = registerTemplate(field);
	...
	public void testConstantOperatorWithOptionalField() throws IOException
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.CONSTANT, new IntegerValue(16), true);
		MessageTemplate template = registerTemplate(field);
	...
	public void testConstantOperatorWithMandatoryField() throws IOException
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.CONSTANT, new IntegerValue(16), false);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.DEFAULT, new IntegerValue(16), true);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.DEFAULT, new IntegerValue(16), false);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.COPY, new IntegerValue(16), true);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.COPY, new IntegerValue(16), false);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.INCREMENT, new IntegerValue(16), true);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.INCREMENT, new IntegerValue(16), false);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.UNSIGNED_INTEGER, Operator.DELTA, new IntegerValue(16), true);
		MessageTemplate template = registerTemplate(field);
	...
	{
		Scalar field = new Scalar("", Type.STRING, Operator.TAIL, new StringValue("abc"), true);
		MessageTemplate template = registerTemplate(field);
		...
		//                     --PMAP-- -----------------#1----------------
		encodeAndAssertEquals("10100000 01100100 01100010 01100101 11100110", msg4);
	...
	{
		Scalar field = new Scalar("", Type.STRING, Operator.TAIL, new StringValue("abc"), false);
		MessageTemplate template = registerTemplate(field);
	...
	private MessageTemplate registerTemplate(Scalar field) {
		MessageTemplate messageTemplate = new MessageTemplate(null, new Field[] { field });
