...
public class HexDump
    ...
    public static void dumpHexData(  byte[] buf )
    {
        dumpHexData ( System.err,"HexDump", buf, buf.length );
    }
    
    public static void dumpHexData( String pTitle,  byte[] buf )
    {
        dumpHexData ( System.err, pTitle, buf, buf.length );
    }
