...
public abstract class Type {
	...
	protected static final byte[] NULL_SF_DECIMAL_VALUE_ENCODING = new byte[] { (byte) 0xc0 };
	protected static final byte[] NULL_TF_DECIMAL_VALUE_ENCODING = new byte[] { (byte) 0xc0, (byte) 0x80 };
	...
	// Type Collections
	public static final Integer[] ALL_TYPES = new Integer[] { UNSIGNED_INTEGER, SIGNED_INTEGER, DECIMAL, STRING, BYTE_VECTOR };
	public static final Integer[] INTEGER_TYPES = new Integer[] { Type.UNSIGNED_INTEGER, Type.SIGNED_INTEGER };

	
	// Type Definitions
	public static final Type UINT = 
		new UnsignedInteger(UNSIGNED_INTEGER, "unsigned integer", new String[] { "u8", "u16", "u32", "u64" });
	
	public static final Type NULLABLE_UNSIGNED_INTEGER = 
		new NullableUnsignedInteger(UNSIGNED_INTEGER, "nullable unsigned integer", new String[] {}, true);
		
	public static final Type INTEGER = 
		new SignedInteger(SIGNED_INTEGER, "signed integer", new String[] { "i8", "i16", "i32", "i64" });

	public static final Type NULLABLE_INTEGER = 
		new NullableSignedInteger(SIGNED_INTEGER, "signed null integer", new String[] {}, true);

	public static final Type STRING_TYPE = 
		new StringType(STRING, "string", new String[] { "string" });
	
	public static final Type NULLABLE_STRING_TYPE = 
		new NullableStringType(STRING, "nullable string", new String[] { "" }, true);
		
	public static final Type BIT_VECTOR = 
		new BitVectorType(null, "bit vector", new String[] { "bitvector", "bit" });
	
	public static final Type BYTE_VECTOR_TYPE = 
		new ByteVectorType(BYTE_VECTOR, "byte vector", new String[] { "bytevector", "byte" });
	...
	public static final Type TF_SCALED_NUMBER = 
		new TwinFieldDecimal(DECIMAL, "twin field scaled number", new String[] {});
	public static final Type STRING_DELTA = new StringDelta(STRING, "Delta String", new String[] {});
	public static final Type NULLABLE_STRING_DELTA = new NullableStringDelta(STRING, "Nullable Delta String", new String[] {});
	...
	public Type(Integer type, String typeName, String[] typeNames, boolean nullable) {
	...
	public static Type getType(Integer type, boolean optional, Operator operator) {
		...
		if (operator instanceof TwinOperator) {
			if (type != DECIMAL)
				throw new IllegalArgumentException("Twin field operators can only be used for decimal values.");
	...
	static {
		...
		TYPE_MAP.put(new Key(UNSIGNED_INTEGER, Boolean.TRUE), NULLABLE_UNSIGNED_INTEGER);
	...
	public static Integer getTypeEnum(String typeName) {
		if (!TYPE_NAME_MAP.containsKey(typeName)) throw new IllegalArgumentException("The type \"" + typeName + "\" is not registered.");
